...
module.exports = {
    ...
    media: {
        ...
        rtmp: {
            ...
            secret: process.env.RTMP_SECRET || 'mirotalkRtmpSecret', // WARNING: Change this in production! Use RTMP_SECRET env var.
            apiSecret: process.env.RTMP_API_SECRET || 'mirotalkRtmpApiSecret', // WARNING: Change this in production! Use RTMP_API_SECRET env var.
    ...
    security: {
         ...
         */
        jwt: {
            key: process.env.JWT_SECRET || 'mirotalksfu_jwt_secret', // WARNING: Change this in production! Use JWT_SECRET env var.
     ...
     */
    api: {
        keySecret: process.env.API_KEY_SECRET || 'mirotalksfu_default_secret', // WARNING: Change this in production! Use API_KEY_SECRET env var.
        allowed: {
