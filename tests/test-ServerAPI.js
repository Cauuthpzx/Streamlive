...
describe('test-ServerAPI', () => {
    ...
    describe('getToken', () => {
        it('should return an encrypted JWT token', () => {
            ...
            signStub
                ...
                .should.be.true();
            // Password is intentionally excluded from token payload for security
            encryptStub
                .calledWith(
    ...
    describe('endMeeting', () => {
        ...
        it('should pass safe redirect URL to peers when provided', () => {
            const removePeerStub = sinon.stub();
            const sendToAllStub = sinon.stub();
            const roomList = new Map([
                [
            ...
            // Only relative paths are allowed (open redirect protection)
        ...
        it('should reject absolute URL redirect to prevent open redirect', () => {
            const removePeerStub = sinon.stub();
            const sendToAllStub = sinon.stub();
            const roomList = new Map([
                [
            ...
            result.should.deepEqual({ success: true, message: 'Meeting ended', room: 'room1' });
            // Absolute URLs are sanitized to empty string
            sendToAllStub
                .calledWith('cmd', {
                    type: 'ejectAll',
                    peer_name: 'API',
